function GetPluginSettings()
{
	return {
		...
		"id":			"TreeView",
		"version":		"1.0",
		"description":	"A Box showing a TreeView.",
		"author":		"Ubivis Media",
		"help url":		"https://github.com/Ubivis/C2TreeView",
...
AddStringParam("Title", "Name of Child Node");
AddStringParam("Icon", "filename of icon for node");
AddAction(0, af_none, "Add Child Node", "TreeView", "Add Child Node {0}", "Add new Child Node.", "AddChild");
